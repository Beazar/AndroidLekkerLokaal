package com.example.sanderbeazar.sportinaalst.injection.module

import com.example.sanderbeazar.sportinaalst.network.SportclubApi
import com.example.sanderbeazar.sportinaalst.utils.BASE_URL
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    internal fun provideSportclubApi(retrofit: Retrofit): SportclubApi {
        return retrofit.create(SportclubApi::class.java)
    }
